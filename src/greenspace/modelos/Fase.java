...
import greenspace.songs.EfeitosSonoros;
		...
		if (emJogo) {
			...
			if (chefao.isVisivel()) {
				...
				if (chefao.getVida() > 119) {
					...
					graficos.drawImage(vidaBoss.getImage(), 250, 650, null);
					ImageIcon gamewinIcon = new ImageIcon("res\\venceu.png");
					graficos.drawImage(gamewinIcon.getImage(), 0, 0, null);
					emJogo = false;
					System.exit(0);				}
			}
			...
			ImageIcon fimJogo = new ImageIcon("res\\fimdejogoold.png");
